...
class AlertProvider {
    ...
    // Simple Alert with more than 2 actions
    ...
    func showActionSheetWithActions(title: String?, message: String?, withCancel: Bool = true, actions: [AlertAction], cancelTitle: String, sourceView: UIView, completion: @escaping (_ action: UIAlertAction) -> ()) {
